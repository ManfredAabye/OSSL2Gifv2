#!/bin/bash
# Erstellt eine eigenständige macOS-App aus PyOSSL2Gif/start.py mit allen Abhängigkeiten
...
# App bauen (onefile, windowed, Icon optional)
...
if [ -f dist/OSSL2Gif ]; then
    echo
    echo "Fertig! Die App befindet sich in dist/OSSL2Gif"
